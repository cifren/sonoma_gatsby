            ...
            <Col>
                <Row>
                    <Col> 
                        ...
                        <div class="text">
                            <h1><a href={companyPdf} target="_blank" rel="noreferrer">Company Overview</a></h1>
                            <p>
            ...
            <Col>
                <Row>
                    <Col>
                        ...
                        <div class="text">
                            <h1>
                                <a href={financialServicePdf} target="_blank" rel="noreferrer">Financial Services</a>
                            </h1>
                            <p>
                                <a href={financialServicePdf} target="_blank" rel="noreferrer">Find out how Sonoma can help you give your customers peace of mind.</a>
                            </p>
                        </div>
                    </Col>
                </Row>
            ...
            <Col>
                <Row>
                    <Col class="col-sm-12 col-md-12">
                        ...
                        <div class="text">
                            <h1>
                                <a href={posPdf} target="_blank" rel="noreferrer">POS Services</a>
                            </h1>
                            <p>
